...
const KitabHaditsPage: FC<KitabHaditsPageProps> = ({ params }) => {
    ...
    const urlGet = `/books/${URLParams.kitabId}/${URLParams.haditsId}`;
...
export default KitabHaditsPage;
